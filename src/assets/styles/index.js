...
// for (let i = 4; i < 49; i = i + 4) {
//   padding['pd' + i] = {padding: i};
//   rightPadding['pdr' + i] = {paddingRight: i};
//   leftPadding['pdl' + i] = {paddingLeft: i};
//   topPadding['pdt' + i] = {paddingTop: i};
//   verticlePadding['pdv' + i] = {paddingVertical: i};
//   horizontalPadding['pdh' + i] = {paddingHorizontal: i};
//   bottomPadding['pdb' + i] = {paddingBottom: i};
// }
...
// const verticleMargin = {};
// const topMargin = {};

// for (let j = 4; j < 41; j = j + 4) {
//   margin['m' + j] = {margin: j};
//   rightMargin['mr' + j] = {marginRight: j};
//   leftMargin['ml' + j] = {marginLeft: j};
//   bottomMargin['mb' + j] = {marginBottom: j};
//   verticleMargin['mv' + j] = {marginVertical: j};
//   horizontalMargin['mh' + j] = {marginHorizontal: j};
//   topMargin['mt' + j] = {marginTop: j};
// }
...
// const generatePaddingStyles = (start, end, step) => {
//   const paddingStyles = {};

//   for (let i = start; i <= end; i += step) {
//     paddingStyles[`pd${i}`] = { padding: i };
//     paddingStyles[`pdr${i}`] = { paddingRight: i };
//     paddingStyles[`pdl${i}`] = { paddingLeft: i };
//     paddingStyles[`pdt${i}`] = { paddingTop: i };
//     paddingStyles[`pdv${i}`] = { paddingVertical: i };
//     paddingStyles[`pdh${i}`] = { paddingHorizontal: i };
//     paddingStyles[`pdb${i}`] = { paddingBottom: i };
//   }

//   return paddingStyles;
// };

// const generateMarginStyles = (start, end, step) => {
//   const marginStyles = {};

//   for (let i = start; i <= end; i += step) {
//     marginStyles[`m${i}`] = { margin: i };
//     marginStyles[`mr${i}`] = { marginRight: i };
//     marginStyles[`ml${i}`] = { marginLeft: i };
//     marginStyles[`mb${i}`] = { marginBottom: i };
//     marginStyles[`mv${i}`] = { marginVertical: i };
//     marginStyles[`mh${i}`] = { marginHorizontal: i };
//     marginStyles[`mt${i}`] = { marginTop: i };
//   }

//   return marginStyles;
// };

// // Function to generate styles for text size
// const generateTextSizeStyles = (start, end) => {
